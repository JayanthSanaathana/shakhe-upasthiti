...
async function listProgramItemShakheSplit({
  ...
  for (const shakhe of shakhes) {
    ...
    const row = {
      ...
      hasItem,
      vibhag: shakhe.vibhag && shakhe.vibhag.entity
        ? { id: shakhe.vibhag.entity.toString(), name: shakhe.vibhag.name }
        : null,
      bhag: shakhe.bhag && shakhe.bhag.entity
        ? { id: shakhe.bhag.entity.toString(), name: shakhe.bhag.name }
        : null,
      nagar: shakhe.nagar && shakhe.nagar.entity
        ? { id: shakhe.nagar.entity.toString(), name: shakhe.nagar.name }
        : null,
      vasati: shakhe.vasati && shakhe.vasati.entity
        ? { id: shakhe.vasati.entity.toString(), name: shakhe.vasati.name }
        : null,
      upavasati: shakhe.upavasati && shakhe.upavasati.entity
        ? { id: shakhe.upavasati.entity.toString(), name: shakhe.upavasati.name }
        : null,
    };
...
async function listShakheStatusSplit({
  ...
  for (const shakhe of shakhes) {
    ...
    const row = {
      ...
      vibhag:
        shakhe.vibhag && shakhe.vibhag.entity
          ? { id: shakhe.vibhag.entity.toString(), name: shakhe.vibhag.name }
          : null,
      bhag:
        shakhe.bhag && shakhe.bhag.entity
          ? { id: shakhe.bhag.entity.toString(), name: shakhe.bhag.name }
          : null,
      nagar:
        shakhe.nagar && shakhe.nagar.entity
          ? { id: shakhe.nagar.entity.toString(), name: shakhe.nagar.name }
          : null,
      vasati:
        shakhe.vasati && shakhe.vasati.entity
          ? { id: shakhe.vasati.entity.toString(), name: shakhe.vasati.name }
          : null,
      upavasati:
        shakhe.upavasati && shakhe.upavasati.entity
          ? { id: shakhe.upavasati.entity.toString(), name: shakhe.upavasati.name }
          : null,
    };
